...
- name: Global Change Information System API - List references in a report.
  x-api-slug: reportreport-identifierreference-get
...
- name: Global Change Information System API - Get a representation of a reference.
  x-api-slug: referencereference-identifier-get
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/references/master/_listings/globalchange-gov/referencereference-identifier-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/references/master/_listings/globalchange-gov/referencereference-identifier-get-openapi.md
- name: Global Change Information System API - Get a representation of a reference.
  x-api-slug: referencereference-identifier-get
  description: Get JSON which represents the structure of a reference.
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/global-change-gov.png
