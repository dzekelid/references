...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/references/master/_listings/predix/apis.md
specificationVersion: "0.14"
apis:
- name: DTW API - Warp subject and reference arrays
  x-api-slug: warp-post
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/references/master/_listings/predix/warp-post-openapi.md
- name: DTW API - Warp subject and reference arrays
  x-api-slug: warp-post
  description: Warp subject and reference arrays.
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/predix-vector-logo.png
