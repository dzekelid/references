...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/references/master/_listings/aws-ec2/apis.md
...
- name: AWS EC2 API - Describe Security Group References ( E C2- V P C only)
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/references/master/_listings/aws-ec2/actiondescribesecuritygroupreferences-ec2vpc-only-get-openapi.md
- name: AWS EC2 API - Describe Security Group References ( E C2- V P C only)
  x-api-slug: actiondescribesecuritygroupreferences-ec2vpc-only-get
  description: '[EC2-VPC only] Describes the VPCs on the other side of a VPC peering
    connection that are referencing the security groups you''ve specified in this
